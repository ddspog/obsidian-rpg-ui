...
function InteractiveInspirational() {
  ...
  return (
    <div style={{ padding: "2rem" }}>
      <Level.Inspirational level={5} inspiration={inspiration} maxPoints={5} onUpdateInspiration={setInspiration} />
      <p style={{ color: "#e3dcce", marginTop: "1rem", fontSize: "0.75rem" }}>Inspiration: {inspiration} / 5</p>
    </div>
  );
}
