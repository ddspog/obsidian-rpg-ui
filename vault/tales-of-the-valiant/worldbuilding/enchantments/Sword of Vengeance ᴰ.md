...
source: From **D&D 5e** "Free Rules (2024)" book by **D&D Beyond**
---
```rpg item.magic
...
applies_to:
  kinds: [weapon]
  families: ["[[Glaive]]", "[[Greatsword]]", "[[Longsword]]", "[[Rapier]]", "[[Scimitar]]", "[[Shortsword]]"]
traits:
  Initiative A.: true
  Skill A.: "[[Perception]]"
---
...
**_Applicable Weapons._** [[Glaive]], Greatsword, [[Longsword]], Rapier, [[Scimitar]], [[Shortsword]].
```
