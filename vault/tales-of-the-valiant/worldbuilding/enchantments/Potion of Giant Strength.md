...
applies_to:
  kinds: [potion]
variants:
  title: Potions of Giant Strength type
  columns: [type_of_giant, strength, rarity, price]
  rows:
    - { type_of_giant: "Hill Giant", strength: 21, rarity: Uncommon, cost: "100 gp" }
    - { type_of_giant: "Frost/Stone Giant", strength: 23, rarity: Rare, cost: "350 gp" }
    - { type_of_giant: "Fire Giant", strength: 25, rarity: Rare, cost: "350 gp" }
