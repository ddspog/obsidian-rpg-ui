...
id: summary
---
![[divine-caster.webp|right|236]]Divine casters draw power from the connectivity between beings. A Divine caster can imbue a dying creature with the will to live, channel a god’s wrath into a fierce storm, or restore withered crops to a starving community. 
...
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/cantrips/]].filter(source like /Divine/).highlight().block(0)"
...
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/1st-circle/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```
...
name: 2nd Circle
entries:
  - "_Aid_ (Abjuration) Raises current and maximum HP."
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/2nd-circle/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```
...
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/3rd-circle/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```
...
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/4th-circle/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```
...
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/5th-circle/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```
...
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/6th-circle/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```
...
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/7th-circle/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```
...
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/8th-circle/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```
...
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/9th-circle/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```
...
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/1st-circle-ritual/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```

```rpg list.divine-ritual-2nd
name: 2nd Circle
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/2nd-circle-ritual/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```

```rpg list.divine-ritual-3rd
name: 3rd Circle
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/3rd-circle-ritual/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```

```rpg list.divine-ritual-4th
name: 4th Circle
entries:
  - "_Divination_ (Divination) Question the future or present."
  - "_Private Sanctum_ (Abjuration) Ensure an area’s privacy."
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/4th-circle-ritual/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```

```rpg list.divine-ritual-5th
name: 5th Circle
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/5th-circle-ritual/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```

```rpg list.divine-ritual-6th
name: 6th Circle
entries:
  ...
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/6th-circle-ritual/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```

```rpg list.divine-ritual-7th
name: 7th Circle
entries:
  - "_Regenerate_ (Transmutation) Heal creature slowly, completely."
  - "_Resurrection_ (Necromancy) Resurrect 100 years dead."
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/7th-circle-ritual/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```

```rpg list.divine-ritual-8th
name: 8th Circle
entries:
  - "_Antipathy/Sympathy_ (Enchantment) Attract or repel creatures."
  - "_Control Weather_ (Transmutation) Change weather within 5 miles."
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/8th-circle-ritual/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```

```rpg list.divine-ritual-9th
name: 9th Circle
entries:
  - "_Foresight_ (Divination) Ally sees immediate future."
  - "_True Resurrection_ (Necromancy) Resurrect 200 years dead."
  - call: "@[[tales-of-the-valiant/worldbuilding/spells/9th-circle-ritual/]].filter(source like /Divine/).highlight().block(0)"
    format: "*[[${name}]]* (${school}) ${summary}"
```
