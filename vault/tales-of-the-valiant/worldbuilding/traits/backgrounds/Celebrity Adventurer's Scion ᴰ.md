...
cssclasses:
  - note-feature
source: _Homebrew from **D&D 5e** "Acquisitions Incorporated" book and adapted to **Tales of the Valiant**_
---
...
```rpg table.adventuring-motivation
|d8*|ADVENTURING MOTIVATION|
|---|---|
|1|I will never get out of my famous parent’s shadow, and adventuring is my attempt to prove myself.|
|2|Adventuring allows me to see the world beyond the suffocating influence of my family's name.|
|3|I grew tired of living under the weight of expectations. Adventuring is my escape from that pressure.|
|4|I am determined to make a name for myself, separate from my family’s exploits.|
|5|Danger and adventure are the only ways I’ll feel close to my absent parent.| 
|6|Adventuring is a means to attain my own fame, surpassing even my parent's legacy.|
|7|The thrill of adventuring is what I’ve always craved—the wealth, the power, the danger.| 
