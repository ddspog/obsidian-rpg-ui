...
|11th|+4|Destroy the Profane (CR 2), Subclass Feature|5|6|4|3|3|3|2|1|—|—|—|
...
traits:
  Cantrips Known: "+1 (any source)"
  Spell Bonus: "+PB to Divine cantrip damage"
```
...
traits:
  Channel Divinity: "1/short rest at Lv 2; 2 at Lv 6; 3 at Lv 13; 4 at Lv 18"
```

>[!rules] Clerics and Gods
...
text: Increase a single ability score by 2.
```

```rpg feature.choice
parent: Improvement
name: Balanced Growth
text: Increase two different ability scores by 1 each.
```
...
level: 5
text: |
  When a Fiend or Undead fails its save against your Turn the Profane feature, it is instantly destroyed if its challenge rating is at or below the threshold shown in the **Destroy the Profane** table.
```
...
text: |
  ...
  If your deity intervenes, you can immediately use your action to cast any spell with a casting time of 1 action from the [[Divine]] spell list or your domain spell list, regardless of preparation rules. Casting in this way doesn't expend a spell slot and doesn't require material components.

  Alternatively, on a successful intervention, your GM can propose the form of the intervention. Anything that replicates the effects of a Divine spell is appropriate. You have final say on allowing the GM to pursue this option or choosing your own spell.
...
traits:
  Divine Intervention: "1/week on success; 1/long rest on failure"
```
...
text: |
  ...
  - **_Gift of Consecration._** You are now immune to disease, poison damage, and the poisoned condition. If you die, your body is instantly preserved as per the _gentle repose_ spell for up to a year and a day.
...
text: |
  **_Gift of Wrath._** Choose either the radiant or necrotic damage type. You are now resistant to damage of the chosen type. In addition, when you cast a spell that deals damage of any type, you can choose for it to deal radiant or necrotic damage instead.
traits:
  Damage Resistance: "+radiant or necrotic (choose at level-up)"
```
...
text: |
  **_Divine Herald._** When you use your Divine Intervention feature, your deity automatically intervenes without a roll, and you no longer have to wait a week before you use Divine Intervention again, though you can still use it only once per long rest.
traits:
  Divine Intervention: "auto-succeeds, 1/long rest (Lv 20)"
```
...
_Subclass of Cleric. Specializes in healing and bolstering allies._
