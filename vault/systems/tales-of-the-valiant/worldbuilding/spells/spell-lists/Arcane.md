...
WHERE contains(magic_source, [[Arcane]])
SORT file.link
```
...
![[arcane-caster.webp|right|256]]_Animate Objects_ (Transmutation) Objects become Constructs for 1 min. 
