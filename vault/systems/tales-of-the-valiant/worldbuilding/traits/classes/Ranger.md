...
---
### Hunter
_Subclass of Ranger. Specializes in tracking and eliminating specific types of prey. (Subclass details not yet documented in this compendium.)_
```
```rpg rule.tab
name: Pack Master
icon: paw-print
...
---
### Pack Master
_Subclass of Ranger. Commands animal companions in battle. (Subclass details not yet documented in this compendium.)_
```
