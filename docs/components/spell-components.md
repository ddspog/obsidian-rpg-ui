...
The `rpg spell` block allows you to display spell information in a clean, organized format. This is perfect for displaying the key details of spells in your character sheet or spellbook.
...
The old `spell-components` block format still works, but `rpg spell` is now the recommended format.
:::
