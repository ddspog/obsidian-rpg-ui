...
export function MonsterHpDisplay(props: MonsterHpDisplayProps) {
  return (
    <div key={`${props.index}-${props.monsterKey}`} className="initiative-monster">
      <div className="initiative-monster-header">
        <span className={`initiative-monster-name ${props.statusClass}`}>{props.monsterLabel}</span>
        <span className="initiative-monster-hp">
          <span className="initiative-hp-value">{props.currentHp}</span>
      ...
      <div className="initiative-monster-actions">
        ...
        />
        <button className="initiative-hp-button initiative-damage" onClick={props.onDamage} title="Damage">
          −
        </button>
        <button className="initiative-hp-button initiative-heal" onClick={props.onHeal} title="Heal">
          +
        </button>
      </div>
    </div>
