...
export function Initiative(props: InitiativeProps) {
  ...
  return (
    <div className="initiative-tracker">
      <InitiativeControls round={props.state.round} onPrev={handlePrev} onNext={handleNext} onReset={handleReset} />
      ...
      <InitiativeList
        ...
        onInitiativeChange={(index, value) => handleSetInitiative(props.static.items[index], value)}
        onInputChange={setInputValue}
        onDamage={(itemIndex, monsterKey) => handleDamage(props.static.items[itemIndex], monsterKey, inputValue)}
        onHeal={(itemIndex, monsterKey) => handleDamage(props.static.items[itemIndex], monsterKey, inputValue, "heal")}
      />
    </div>
  );
}
