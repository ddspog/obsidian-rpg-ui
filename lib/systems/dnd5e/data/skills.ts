...
export default [
  ...
  },
  {
    ...
    subtitle: "Associated Ability: INT",
    $contents:
      "Looking around for clues and making deductions based on those clues involves an INT (Investigation) check. You might deduce the location of a hidden object, discern from a wound what kind of weapon dealt it, or determine the weakest point in a tunnel that could cause it to collapse.",
  },
  {
    $name: "Medicine",
    attribute: "wisdom",
  ...
  },
  {
    ...
    subtitle: "Associated Ability: CHA",
    $contents:
      "When you attempt to influence someone or a group of people with tact, social graces, or good nature, the GM might ask for a CHA (Persuasion) check. You use Persuasion when acting in good faith, to foster friendships, make cordial requests, or exhibit proper etiquette.",
  },
  {
    $name: "Religion",
    attribute: "intelligence",
  ...
  },
  {
    ...
    subtitle: "Associated Ability: DEX",
    $contents:
      "An act of legerdemain or manual trickery, such as planting an item on someone else or concealing an object on your person, calls for a DEX (Sleight of Hand) check. The GM might also call for a DEX (Sleight of Hand) check to determine whether you lift a coin purse off another person.",
  },
  {
    $name: "Stealth",
    attribute: "dexterity",
