 ...
 */
export function updateDeathSaveSuccesses(currentSuccesses: number, index: number): number {
 ...
 */
export function updateDeathSaveFailures(currentFailures: number, index: number): number {
